...
//      console.log('webkitTransitionEnd');
  ...
  onChangeAction: function (e) { /* 2012.08.23 - Added onchange event */
    ...
    div.innerHTML = '<div id="sw-header"><div style="display:none;" id="sw-cancel">Cancel</' + 'div><div id="sw-done">Ok</' + 'div></' + 'div><div id="sw-slots-wrapper"><div id="sw-slots"></' + 'div></' + 'div><div id="sw-frame"></' + 'div>';
